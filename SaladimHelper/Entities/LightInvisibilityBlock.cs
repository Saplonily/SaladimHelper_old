...
public class LightInvisibilityBlock : Solid, IInvisible
{
    ...
    public LightInvisibilityBlock(EntityData data, Vector2 offset)
        : this(data.Position + offset, data.Width, data.Height, data.Char("tile_type", '3'), data.Bool("fear_player_light"))
    { }

    public LightInvisibilityBlock(Vector2 position, float width, float height, char tile, bool fearPlayerLight)
